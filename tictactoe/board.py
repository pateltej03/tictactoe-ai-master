...
class Board:
    ...
    # Wild
    # def winner(self) -> Optional[Symbol]:
    #     """Return the symbol of the opponent if a player has formed a line (indicating the GUI 'winner')."""
    #     losing_player = self.loser()
    #     if losing_player is None:
    #         return None
    #     return Symbol.CROSS if losing_player == Symbol.CIRCLE else Symbol.CIRCLE

    def loser(self) -> Optional[Symbol]:
        """Return the symbol of the player who has formed a line (indicating a loss)."""
        connection = self.get_connection()
        if len(connection) == 0:
            return None
        else:
    ...
    def is_gameover(self) -> bool:
        ...
        """
        return self.loser() is not None or self.is_draw()
...
if __name__ == "__main__":
    ...
    if board.is_draw():
        ...
        print("Player 1" if board.loser() == Symbol.CIRCLE else "Player 2",
              " Wins....!")
